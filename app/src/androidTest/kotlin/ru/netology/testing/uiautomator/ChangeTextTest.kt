...
//    }
    ...
    fun testNotChangeText() {
        ...
        val beforeResult = device.findObject(By.res(MODEL_PACKAGE, "textToBeChanged")).text
        device.findObject(By.res(MODEL_PACKAGE, "userInput")).text = ""
        device.findObject(By.res(MODEL_PACKAGE, "buttonChange")).click()

        val afterResult = device.findObject(By.res(MODEL_PACKAGE, "textToBeChanged")).text
